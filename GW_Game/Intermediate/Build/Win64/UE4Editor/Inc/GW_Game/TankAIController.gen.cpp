...
// Cross Module References
	...
	GW_GAME_API UFunction* Z_Construct_UFunction_ATankAIController_OnPossessedTankDeath();
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_ATankAIController, "OnPossessedTankDeath", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00040401, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
	...
	UClass* Z_Construct_UClass_ATankAIController()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_ATankAIController_OnPossessedTankDeath, "OnPossessedTankDeath" }, // 1307410120
			};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ATankAIController, 1379450694);
